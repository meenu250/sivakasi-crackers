                    ...
                    return (
                      <div className="billing-item-row" key={i}>
                        <select value={item.productId} onChange={e => setBillItem(i, 'productId', e.target.value)}>
                          ...
                          {products.map(p => <option key={p.id} value={p.id}>{p.name} (MRP: ₹{p.mrp || p.price}) [Stock: {p.stock}]</option>)}
                        </select>
                  ...
                  <div style={{ display:'flex', alignItems:'center', gap:6 }}>
                    ...
                    <div style={{ display:'flex', alignItems:'center', border:'1px solid var(--border)', borderRadius:7, overflow:'hidden' }}>
                      <input type="number" min={0} max={99}
                        ...
                        style={{ width:52, padding:'5px 8px', border:'none', fontSize:13, textAlign:'center' }}
                        placeholder="0"
                      />
